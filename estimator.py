...
class TfPoseEstimator:
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                if i==11:
                    coord_Lhip=center
                # if i==10 or i==13:
                #     if center[1]>maxAnkle:
                #         maxAnkle=center[1]
                    
                # while center[0]>max_coord_Up and (i!=9 or i!=10 or i!=12 or i!=13):
                #     maxcoordUp=center[0]
                # while center[0]<mincoordUp and (i!=9 or i!=10 or i!=12 or i!=13):
                #     mincoordUp=center[0]
                while center[0] > max_coord_lower and (i>=8 and i<=13):
                    max_coord_lower = center[0]
                while center[0] < min_coord_lower and (i>=8 and i<=13):
                    min_coord_lower = center[0]
        ...
        if(coord_Lhip[1] > coord_Rhip[1]):
            coord_hip = coord_Rhip
        else:
            coord_hip = coord_Lhip
        #return npimg,coordRhip,coordLhip,maxcoordUp,mincoordUp,maxcoordLo,mincoordLo,maxAnkle
        return npimg,coord_hip, max_coord_lower, min_coord_lower
        #return npimg
